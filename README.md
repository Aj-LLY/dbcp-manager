...
基于 Python Tkinter 的桌面端看板应用，用于管理项目的进度跟踪和流程管理。

**版本**: v2.1.0 | **运行环境**: Windows 7/10/11 | **语言**: Python 3.x
...
### 方式一：直接运行 EXE（推荐）
下载 [releases/项目进度管理系统_v2.1.0.exe](releases/项目进度管理系统_v2.1.0.exe)，双击运行，无需安装 Python。
